...
vlog -work work clkm_gen_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax clkm_gen_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.clkm_gen_tb work.glbl
