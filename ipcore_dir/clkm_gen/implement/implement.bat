...
xst -ifn xst.scr
move clkm_gen_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clkm_gen_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clkm_gen_exdes.ucf clkm_gen_exdes

echo 'Running map'
map -timing -pr b clkm_gen_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clkm_gen_exdes -w routed.ncd routed.v
cd ..
