...
xst -ifn xst.scr
move pll_50_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll_50_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll_50_exdes.ucf pll_50_exdes

echo 'Running map'
map -timing -pr b pll_50_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm pll_50_exdes -w routed.ncd routed.v
cd ..
