...
vlog -work work pll_50_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax pll_50_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.pll_50_tb work.glbl
